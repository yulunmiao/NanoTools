// -*- C++ -*-
// Generated with args: /hadoop/cms/store/group/snt/nanoaod/mc/RunIIAutumn18NanoAODv6/ZZZJetsTo4L2Nu_4f_TuneCP5_13TeV_amcatnloFXFX_pythia8/NANOAODSIM/Nano25Oct2019_102X_upgrade2018_realistic_v20-v1/60000/37BD4D82-9D93-6F47-8686-D1BEFB8201A6.root
#ifndef Nano_H
#define Nano_H
...
protected:
    ...
    float Electron_dr03HcalDepth1TowerSumEt_[33];
    ...
    bool Electron_mvaFall17V1Iso_WP90_[33];
    ...
    bool Electron_mvaFall17V1noIso_WP90_[33];
    ...
    bool Electron_mvaFall17V1noIso_WPL_[33];
    ...
    bool Electron_mvaFall17V2Iso_WP90_[33];
    ...
    bool Electron_mvaFall17V2noIso_WP90_[33];
    ...
    bool Electron_mvaFall17V2noIso_WPL_[33];
    ...
    float FatJet_btagDDBvL_noMD_[21];
    ...
    float FatJet_btagDDCvB_noMD_[21];
    ...
    float FatJet_btagDDCvL_noMD_[21];
    ...
    float Tau_photonsOutsideSignalCone_[30];
...
namespace tas {
    ...
    const vector<float> &GenPart_mass(); // Mass stored for all particles with mass > 10 GeV and photons with mass > 1 GeV, plus W/Z and BSM particles. For other particles you can lookup from PDGID
